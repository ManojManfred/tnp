                ...
                <div class="container-fluid detached-nav">
                    ...
                    <div class="logo-topbar">
                        ...
                        <a href="index.html" class="logo-light">
                            <span class="logo-lg">
                                <img src="assets/images/srkr.png" alt="logo" height="22">
                            </span>
                            <span class="logo-sm">
                                <img src="assets/images/srkr.png" alt="small logo" height="22">
                            </span>
                        </a>s
                        ...
                        <a href="index.html" class="logo-dark">
                            <span class="logo-lg">
                                <img src="assets/images/srkr.png" alt="dark logo" height="22">
                            </span>
                            <span class="logo-sm">
                                <img src="assets/images/srkr.png" alt="small logo" height="22">
                            </span>
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarCrm">
                                <ul class="side-nav-second-level">
                                    ...
                                    <!-- <li>
                                        <a href="edit-student.php">Add Student</a>
                                    </li>
                                    <li>
...
<!-- 
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarProjects">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="apps-projects-list.html">Add Event</a>
                                    </li>
                                    <li>
                                        <a href="apps-projects-details.html">Edit event</a>
                                    </li>
                                    <!-- <li>
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarTasks">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="apps-tasks.html">Add new admin</a>
                                    </li>
                                    <li>
                                        <a href="apps-tasks-details.html">change password</a>
                                    </li>
                                    <!-- <li>
